...
def aesenc():
    ...
    f=open("CryptoCode1\F2\BinfileName11.bin")
    plaintext=''
    for i in f:
        plaintext+=i
    f.close()
    ...
    f2=open('CryptoCode1\F2\BinfileName11.bin','wb')
    f2.write(ciphertext)
...
def desenc():
    ...
    f=open("CryptoCode1\F2\BinfileName12.bin")
    ...
    f2=open('CryptoCode1\F2\BinfileName12.bin','wb')
    f2.write(e)
...
def rc4enc():
    ...
    f=open("CryptoCode1\F2\BinfileName13.bin")
    ...
    f2=open('CryptoCode1\F2\BinfileName13.bin','wb')
    f2.write(cipher)
...
def stegnoimg(k,iv,di,r,l,imn,nimn):
    ...
    lo="CryptoCode1\\UploadF\\"+imn

    secret = lsb.hide(lo,c)
    
    loc="CryptoCode1\\encFile\\"+nimn+".png"
    secret.save(loc)
