...
def stegnoimg(use,ilo):
    ...
    ilo="CryptoCode1\\UploadFdec\\"+ilo+".png"
...
def aesdec():
    ...
    f=open('CryptoCode1\F2\BinfileName11.bin','rb')
    ciphertext=b''
    ...
    try:
        ...
        f3=open('CryptoCode1\F2\BinfileName11.bin','w')
...
def desdec():
    global key,di
    f=open('CryptoCode1\F2\BinfileName12.bin','rb')
    e=b''
    ...
    try:
       key0 = DesKey(key)
       d=key0.decrypt(e) 
       f2=open('CryptoCode1\F2\BinfileName12.bin','w')
...
def rc4dec():
    ...
    f=open('CryptoCode1\F2\BinfileName13.bin','rb')
    cipher=b''
    ...
    try:
        ...
        f2=open('CryptoCode1\F2\BinfileName13.bin','w')
